    ...
    <div className='purchase-orders-page'>
      ...
      {loading ? (
        ...
        <div className='orders-table-container'>
          <div className='orders-found-count'>Found {totalCount} orders</div>
          ...
          >
            ...
            <div className='order-detail-section'>
              ...
              <table className='order-items-list'>
                ...
                <tbody>
                  {selectedOrder.rentItems &&
                    selectedOrder.rentItems.map((item, idx) => (
                      <tr key={idx}>
                        <td>
                          {item.imageUrl && (
                            <img
            ...
            <div className='status-update-section'>
              <div className='filter-group' style={{ flex: 1 }}>
                ...
                <select
                  ...
                  style={{ width: "100%" }}
                >
                  <option value='WAITING_FOR_DELIVERY'>
              ...
              <button
                ...
                style={{
                  opacity:
                    updating || newStatus === selectedOrder.status ? 0.5 : 1,
                }}
              >
